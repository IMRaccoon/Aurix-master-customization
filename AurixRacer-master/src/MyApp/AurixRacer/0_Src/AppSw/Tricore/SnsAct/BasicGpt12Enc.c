...
#endif
    IfxPort_setPinModeInput(IfxPort_P00_7.port, IfxPort_P00_7.pinIndex, IfxPort_InputMode_pullUp);
	IfxPort_setPinModeInput(IfxPort_P00_8.port, IfxPort_P00_8.pinIndex, IfxPort_InputMode_pullUp);
	IfxPort_setPinModeInput(IfxPort_P00_9.port, IfxPort_P00_9.pinIndex, IfxPort_InputMode_pullUp);
